...
const ResumeAndContacts = () => {
    ...
    return (
        <div className="min-h-screen max-h-screen inset-0 w-full snap-always snap-start bg-slate-900 flex flex-col" id="Resume">
            ...
            <div className="w-full h-fit pt-24 md:pt-32 pb-4 sm:pb-12 lg:px-40 bg-slate-200"> {/* Resume */}
                <div className="relative w-fit h-fit mx-auto lg:mx-0 lg:left-16 font-extrabold font-sans text-4xl sm:text-5xl"> Resume </div> {/* TITLE */}
                    ...
                    <div className='slideUp flex flex-col sm:flex-row my-2 2xl:my-4 bg-slate-50 w-4/6 h-fit p-4 2xl:p-8 mx-auto rounded-3xl shadow-md'>{/*Resume Card */}
                        ...
                        {/* <div className='ml-auto mt-auto w-fit h-fit py-3 px-5 rounded-full bg-blue-700 shadow-sm shadow-cyan-300/50 hover:bg-blue-800 hover:cursor-pointer duration-150 text-slate-50 text-xl font-bold'>
                            View
                        </div> */}
                        <a href={RESUMEFILE}
                        ...
                        className='mx-auto 2xl:ml-auto 2xl:mr-10 mt-auto w-fit h-fit py-2 2xl:py-3 px-3 2xl:px-5 rounded-full bg-blue-700 shadow-md shadow-cyan-300/50 hover:bg-blue-800 hover:cursor-pointer duration-150 text-slate-50 2xl:text-xl font-bold'>
                            Download
                        </a>
                    </div>
            </div>

            <div className="w-full relative pt-8 lg:px-40" id="Contact">{/* Contact */}
                <div className="relative w-fit h-fit mx-auto lg:mx-0 lg:left-16 font-extrabold text-white font-sans text-4xl sm:text-5xl"> Contacts </div> {/* TITLE */}
                    <div className="w-fit pt-8 sm:pt-10 mx-auto text-slate-100 text-base sm:text-xl">
                        Let's have a chat !
                    </div>
                    <div className="flex flex-row w-fit sm:w-1/2 relative mx-auto pt-0 sm:px-20 h-fit">
                    {/* Social media Handles Array */}
                        <a href='https://github.com/ziddou701' className="mx-auto w-fit p-5 rounded-full hover:bg-slate-500 hover:cursor-pointer duration-150">
                            {/* Github SVG */}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="fill-slate-50 w-8 sm:w-10">
                        ...
                        <a href='https://www.linkedin.com/in/ousmane-konate-22b716290/' className="mx-auto w-fit p-5 rounded-full hover:bg-slate-500 hover:cursor-pointer duration-150">
                            {/* LinkedIn svg */}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="fill-slate-50 w-8 sm:w-10">
                        ...
                        <a href="mailto:ousmane.z.konate@hotmail.com" className="mx-auto w-fit p-5 rounded-full hover:bg-slate-500 hover:cursor-pointer duration-150">
                            {/* Email contact svg */}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="fill-slate-50 w-8 sm:w-10">
